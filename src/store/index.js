  ...
  roadmap: {
    ...
    EXTRAS: {
      ...
      milestones: {
        ...
        "Levels.fyi": {
          url: "https://www.levels.fyi/services/?from=subnav",
          imgUrl: "https://i.imgur.com/oTScVpY.png",
          imgUrlSm: "levels.png",
          iconUrl:
            "https://danielsbrew.com/wp-content/uploads/2020/12/Levels-fyi-1024x1024.jpg",
          iconUrlSm: "levelslogo.jpg",
          complete: false,
          primary: true,
          description:
            "Secure the best job offers with the assistance of levels.fyi. Even if you're currently unemployed or have just one offer, this package ensures you aim for the top. For a single investment, you receive a full 3 months of comprehensive, end-to-end support for all your job offers. Benefit from the expertise of a seasoned recruiter with over 5 years in the industry. Enjoy flexibility with a cancellation policy that offers a full refund up to 48 hours before your initial session. Don't just settle; maximize your potential and secure the best for your career.",
        },

        "Hiring Cafe": {
          url: "https://hiring.cafe/",
          imgUrl: "https://i.imgur.com/gxyncWQ.png",
          imgUrlSm: "hiringcafe.png",
          iconUrl:
            "https://miro.medium.com/max/1200/1*zSkrCcZ95-vbRNgBXB1n6Q.jpeg",
          iconUrlSm: "ai.jpg",
          complete: false,
          primary: true,
          description:
            "Recently, I stumbled upon Hiring Cafe, and I'm genuinely impressed! Powered by AI, this platform gathers new job postings from hundreds of thousands of companies, offering a distinctive edge in the job hunt. The brilliance lies in its ability to let you register for job openings even before they make their way to big platforms like LinkedIn or Indeed. For anyone serious about staying a step ahead in their career search, Hiring Cafe is the secret weapon you didn't know you needed. An absolute game-changer in job hunting.",
        },
      },
    },
  },
